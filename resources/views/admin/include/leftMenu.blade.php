     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="@yield('packages') treeview">
          <a href="#">
            <i class="fa fa-shopping-bag"></i><span>Client</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('getAgent')}}"><i class="fa fa-circle-o"></i>Client Lists</a></li>
          </ul>
        </li>
        <li class="@yield('services') treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('getOurService')}}"><i class="fa fa-circle-o"></i>CV List</a></li>           
          </ul>
        </li>
         <li class="@yield('program') treeview">
          ...
          <ul class="treeview-menu">            
            <li><a href="{{route('postList')}}"><i class="fa fa-circle-o"></i>Jobs List</a></li>
